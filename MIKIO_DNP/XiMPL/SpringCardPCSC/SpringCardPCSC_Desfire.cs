/**h* SpringCard/PCSC_Desfire
 *
 * NAME
 *   PCSC_Desfire
 * 
 * DESCRIPTION
 *   SpringCard's wrapper for pcsc_desfire.dll, the library to work
 *   with NXP Desfire (EV0 and EV1) chips within PC/SC
 *
 * COPYRIGHT
 ...
 *
 * HISTORY
 *   JIZ 24/04/2012 : first official release
 *
 * PORTABILITY
...
namespace SpringCard.PCSC.Desfire
{
