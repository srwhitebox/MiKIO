...
namespace XiMPLib.xUI {
    public class xcEditText : TextBox{
        ...
        public xcEditText(xcJObject jProperties, Uri parentUri) {
            ParentUri = parentUri;
        ...
        public void apply(xcJProperty property) {
            ...
            switch (property.Key) {
                ...
                case "charactercasing":
                    this.CharacterCasing = property.CharacterCasing;
                    break;
                ...
                case "acceptsenter":
                case "multiline":
                    this.AcceptsReturn = property.Boolean;
                    break;
                ...
                case "verticalscrollbar":
                    ...
                    break;
                case "acceptstab":
                    this.AcceptsTab = property.Boolean;
                    break;
                case "maxlines":
                    this.MaxLines = property.Integer;
                    break;
                case "minlines":
                    this.MinLines = property.Integer;
                    break;
                case "maxlength":
                    this.MaxLength = property.Integer;
                    break;
                case "value":
                case "text":
                case "content":
